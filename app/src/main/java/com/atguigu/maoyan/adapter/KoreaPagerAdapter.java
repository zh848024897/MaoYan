 ...
 */
public class KoreaPagerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private final Context context;
    private final OverseasKoreaBean overseasKoreaBean;
    private final List<OverseasKoreaBean.DataBean.HotBean> hots;

    public KoreaPagerAdapter(Context context, OverseasKoreaBean overseasKoreaBean) {
        this.context = context;
        this.overseasKoreaBean = overseasKoreaBean;
        hots = overseasKoreaBean.getData().getHot();
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setData(Context context, OverseasKoreaBean.DataBean.HotBean hotBean) {
